...
namespace MovieProDemo.Services
{
    public class TMDBMappingService : IDataMappingService
    {
        ...
        {
            var posterPath = $"{_appSettings.TMDBSettings.BaseImagePath}/{_appSettings.CinematicSuiteSettings.DefaultPosterSize}/{path}";
        ...
        private string BuildCastImage(string profilePath)
        {
            if (string.IsNullOrEmpty(profilePath))
                return _appSettings.CinematicSuiteSettings.DefaultCastImage;

            return $"{_appSettings.TMDBSettings.BaseImagePath}/{_appSettings.CinematicSuiteSettings.DefaultPosterSize}/{profilePath}";
        }
