...
namespace CinematicSuite.Controllers
{
    public class CollectionsController : Controller
    {
        ...
        {
            var defaultCollectionName = _appSettings.CinematicSuiteSettings.DefaultCollection.Name;
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Collection collection)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    if (collection.Name == _appSettings.CinematicSuiteSettings.DefaultCollection.Name)
                    {
